...
module Rails
  class << self
    # source://railties/7.1.0/lib/rails.rb#42
    def app_class; end

    # source://railties/7.1.0/lib/rails.rb#42
    def app_class=(_arg0); end

    # source://railties/7.1.0/lib/rails.rb#43
    def application; end

    # source://railties/7.1.0/lib/rails.rb#41
    def application=(_arg0); end

    # source://railties/7.1.0/lib/rails.rb#123
    def autoloaders; end

    # source://railties/7.1.0/lib/rails.rb#54
    ...
    # source://railties/7.1.0/lib/rails.rb#50
    def configuration; end

    # source://railties/7.1.0/lib/rails/deprecator.rb#4
    def deprecator; end

    # source://railties/7.1.0/lib/rails.rb#72
    def env; end

    # source://railties/7.1.0/lib/rails.rb#79
    def env=(environment); end

    # source://railties/7.1.0/lib/rails.rb#90
    def error; end

    # source://railties/7.1.0/lib/rails/gem_version.rb#5
    def gem_version; end

    # source://railties/7.1.0/lib/rails.rb#103
    def groups(*groups); end

    # source://railties/7.1.0/lib/rails.rb#47
    ...
    # source://railties/7.1.0/lib/rails.rb#119
    def public_path; end

    # source://railties/7.1.0/lib/rails.rb#63
    def root; end

    # source://railties/7.1.0/lib/rails/version.rb#7
    def version; end
  end
end
...
class Rails::Application < ::Rails::Engine
  # source://railties/7.1.0/lib/rails/application.rb#109
  ...
  # source://railties/7.1.0/lib/rails/application.rb#102
  def autoloaders; end

  # source://railties/7.1.0/lib/rails/engine.rb#510
  def build_middleware_stack; end

  # source://railties/7.1.0/lib/rails/application.rb#434
  def config; end

  # source://railties/7.1.0/lib/rails/application.rb#438
  def config=(_arg0); end

  # source://railties/7.1.0/lib/rails/application.rb#271
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/application.rb#354
  def console(&blk); end

  # source://railties/7.1.0/lib/rails/application.rb#499
  def credentials; end

  # source://railties/7.1.0/lib/rails/application.rb#457
  def credentials=(_arg0); end

  # source://railties/7.1.0/lib/rails/application.rb#104
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.1.0/lib/rails/application.rb#104
  def default_url_options=(arg); end

  # source://railties/7.1.0/lib/rails/application.rb#230
  def deprecators; end

  # source://railties/7.1.0/lib/rails/application.rb#557
  def eager_load!; end

  # source://railties/7.1.0/lib/rails/application.rb#518
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/application.rb#300
  def env_config; end

  # source://railties/7.1.0/lib/rails/application.rb#102
  def executor; end

  # source://railties/7.1.0/lib/rails/application.rb#360
  def generators(&blk); end

  # source://railties/7.1.0/lib/rails/application.rb#531
  ...
  # source://railties/7.1.0/lib/rails/application.rb#421
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/application.rb#134
  def initialized?; end

  # source://railties/7.1.0/lib/rails/application.rb#342
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/7.1.0/lib/rails/application.rb#428
  def initializers; end

  # source://railties/7.1.0/lib/rails/application.rb#371
  def isolate_namespace(mod); end

  # source://railties/7.1.0/lib/rails/application.rb#161
  def key_generator(secret_key_base = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/application.rb#551
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/application.rb#222
  def message_verifier(verifier_name); end

  # source://railties/7.1.0/lib/rails/application.rb#197
  def message_verifiers; end

  # source://railties/7.1.0/lib/rails/application.rb#547
  ...
  # source://railties/7.1.0/lib/rails/application.rb#335
  def rake_tasks(&block); end

  # source://railties/7.1.0/lib/rails/application.rb#153
  ...
  # source://railties/7.1.0/lib/rails/application.rb#397
  def require_environment!; end

  # source://railties/7.1.0/lib/rails/application.rb#402
  def routes_reloader; end

  # source://railties/7.1.0/lib/rails/application.rb#138
  def run_load_hooks!; end

  # source://railties/7.1.0/lib/rails/application.rb#348
  def runner(&blk); end

  # source://railties/7.1.0/lib/rails/application.rb#100
  def sandbox; end
  ...
  # source://railties/7.1.0/lib/rails/application.rb#475
  def secret_key_base; end

  # source://railties/7.1.0/lib/rails/application.rb#440
  def secrets; end

  # source://railties/7.1.0/lib/rails/application.rb#457
  def secrets=(_arg0); end

  # source://railties/7.1.0/lib/rails/application.rb#366
  def server(&blk); end

  # source://railties/7.1.0/lib/rails/application.rb#527
  def to_app; end

  # source://railties/7.1.0/lib/rails/application.rb#409
  def watchable_args; end

  protected

  # source://railties/7.1.0/lib/rails/application.rb#630
  def default_middleware_stack; end

  # source://railties/7.1.0/lib/rails/application.rb#645
  def ensure_generator_templates_added; end

  # source://railties/7.1.0/lib/rails/application.rb#596
  def ordered_railties; end

  # source://railties/7.1.0/lib/rails/application.rb#618
  def railties_initializers(current); end

  # source://railties/7.1.0/lib/rails/application.rb#585
  def run_console_blocks(app); end

  # source://railties/7.1.0/lib/rails/application.rb#575
  def run_generators_blocks(app); end

  # source://railties/7.1.0/lib/rails/application.rb#580
  def run_runner_blocks(app); end

  # source://railties/7.1.0/lib/rails/application.rb#590
  def run_server_blocks(app); end

  # source://railties/7.1.0/lib/rails/application.rb#564
  def run_tasks_blocks(app); end

  # source://railties/7.1.0/lib/rails/application.rb#635
  def validate_secret_key_base(secret_key_base); end

  private

  # source://railties/7.1.0/lib/rails/application.rb#683
  def build_middleware; end

  # source://railties/7.1.0/lib/rails/application.rb#676
  def build_request(env); end

  # source://railties/7.1.0/lib/rails/application.rb#687
  def coerce_same_site_protection(protection); end

  # source://railties/7.1.0/lib/rails/application.rb#691
  def filter_parameters; end

  # source://railties/7.1.0/lib/rails/application.rb#651
  def generate_local_secret; end

  # source://railties/7.1.0/lib/rails/application.rb#670
  def secrets_secret_key_base; end

  class << self
    # source://railties/7.1.0/lib/rails/application.rb#390
    def add_lib_to_load_path!(root); end

    # source://railties/7.1.0/lib/rails/application.rb#84
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/7.1.0/lib/rails/application.rb#88
    def find_root(from); end

    # source://railties/7.1.0/lib/rails/application.rb#71
    def inherited(base); end

    # source://railties/7.1.0/lib/rails/application.rb#80
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/7.1.0/lib/rails/application/configuration.rb#30
  def initialize(*_arg0); end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#14
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#532
  def annotations; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#28
  def api_only; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#375
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#464
  def autoload_lib(ignore:); end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#476
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#488
  def colorize_logging; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#492
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#537
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#427
  def database_configuration; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#382
  def debug_exception_response_format; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#386
  def debug_exception_response_format=(_arg0); end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#554
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#357
  def enable_dependency_loading; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#362
  def enable_dependency_loading=(value); end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#343
  def enable_reloading; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#347
  def enable_reloading=(value); end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#28
  def encoding; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#367
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#566
  def inspect; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#409
  def load_database_yaml; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#92
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#388
  def paths; end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#546
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#339
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#512
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/7.1.0/lib/rails/application/configuration.rb#528
  ...
  # source://railties/7.1.0/lib/rails/application/configuration.rb#591
  def credentials_defaults; end
end

# source://sprockets-rails//lib/sprockets/railtie.rb#57
class Rails::Engine < ::Rails::Railtie
  # source://railties/7.1.0/lib/rails/engine.rb#432
  def initialize; end
  ...
  # source://railties/7.1.0/lib/rails/engine.rb#527
  def call(env); end

  # source://railties/7.1.0/lib/rails/engine.rb#546
  def config; end

  # source://railties/7.1.0/lib/rails/engine.rb#484
  def eager_load!; end

  # source://railties/7.1.0/lib/rails/engine.rb#522
  def endpoint; end

  # source://railties/7.1.0/lib/rails/engine.rb#430
  def engine_name(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.1.0/lib/rails/engine.rb#533
  def env_config; end

  # source://railties/7.1.0/lib/rails/engine.rb#494
  def helpers; end

  # source://railties/7.1.0/lib/rails/engine.rb#505
  def helpers_paths; end

  # source://railties/7.1.0/lib/rails/engine.rb#430
  def isolated?(&block); end

  # source://railties/7.1.0/lib/rails/engine.rb#446
  def load_console(app = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/engine.rb#470
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/engine.rb#455
  def load_runner(app = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/engine.rb#554
  def load_seed; end

  # source://railties/7.1.0/lib/rails/engine.rb#479
  def load_server(app = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/engine.rb#462
  def load_tasks(app = T.unsafe(nil)); end

  # source://railties/7.1.0/lib/rails/engine.rb#429
  def middleware(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.1.0/lib/rails/engine.rb#429
  def paths(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.1.0/lib/rails/engine.rb#489
  def railties; end

  # source://railties/7.1.0/lib/rails/engine.rb#429
  def root(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.1.0/lib/rails/engine.rb#539
  def routes(&block); end

  # source://railties/7.1.0/lib/rails/engine.rb#670
  def routes?; end

  protected

  # source://railties/7.1.0/lib/rails/engine.rb#675
  def run_tasks_blocks(*_arg0); end

  private

  # source://railties/7.1.0/lib/rails/engine.rb#707
  def _all_autoload_once_paths; end

  # source://railties/7.1.0/lib/rails/engine.rb#711
  def _all_autoload_paths; end

  # source://railties/7.1.0/lib/rails/engine.rb#720
  def _all_load_paths(add_autoload_paths_to_load_path); end

  # source://railties/7.1.0/lib/rails/engine.rb#744
  def build_middleware; end

  # source://railties/7.1.0/lib/rails/engine.rb#736
  def build_request(env); end

  # source://railties/7.1.0/lib/rails/engine.rb#703
  def default_middleware_stack; end

  # source://railties/7.1.0/lib/rails/engine.rb#731
  def fixtures_in_root_and_not_in_vendor?(fixtures); end

  # source://railties/7.1.0/lib/rails/engine.rb#687
  def has_migrations?; end

  # source://railties/7.1.0/lib/rails/engine.rb#681
  ...
  class << self
    ...
    # source://railties/7.1.0/lib/rails/engine.rb#353
    def called_from; end

    # source://railties/7.1.0/lib/rails/engine.rb#353
    def called_from=(_arg0); end

    # source://railties/7.1.0/lib/rails/engine.rb#358
    def eager_load!(*_arg0, **_arg1, &_arg2); end

    # source://railties/7.1.0/lib/rails/engine.rb#378
    def endpoint(endpoint = T.unsafe(nil)); end

    # source://railties/7.1.0/lib/rails/railtie.rb#176
    def engine_name(name = T.unsafe(nil)); end

    # source://railties/7.1.0/lib/rails/engine.rb#416
    def find(path); end

    # source://railties/7.1.0/lib/rails/engine.rb#374
    def find_root(from); end

    # source://railties/7.1.0/lib/rails/engine.rb#691
    def find_root_with_flag(flag, root_path, default = T.unsafe(nil)); end

    # source://railties/7.1.0/lib/rails/engine.rb#360
    def inherited(base); end

    # source://railties/7.1.0/lib/rails/engine.rb#384
    def isolate_namespace(mod); end
